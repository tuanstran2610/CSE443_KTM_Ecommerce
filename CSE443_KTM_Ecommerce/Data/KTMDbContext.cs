...
namespace CSE443_KTM_Ecommerce.Data
{
    public class KTMDbContext : IdentityDbContext<User, Role, int>
    {
        ...
        {
            // Call base.OnModelCreating first to ensure Identity configurations are applied
            ...
            modelBuilder.Entity<ProductType>().HasData(
                new ProductType { Id = 1, Name = "Football" },
                new ProductType { Id = 2, Name = "Hat" },
                new ProductType { Id = 3, Name = "Toy" },
                new ProductType { Id = 4, Name = "Scarf" },
                new ProductType { Id = 5, Name = "Book/Magazines" },
                new ProductType { Id = 6, Name = "Gloves" },
                new ProductType { Id = 7, Name = "Bag" },
                new ProductType { Id = 8, Name = "Running" });

            // Seed data for Categories
            modelBuilder.Entity<Category>().HasData(
                new Category { Id = 1, Name = "Jersey" },
