        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CouponMinSpend = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    CouponMaxSpend = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryFees = table.Column<decimal>(type: "decimal(10,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Deliveries",
                columns: new[] { "Id", "DeliveryFees", "Description", "Name" },
                values: new object[,]
                {
                    { 1, 2.99m, "Delivered in 3–5 days", "Standard Delivery" },
                    { 2, 5.99m, "Delivered in 1–2 days", "Express Delivery" },
                    { 3, 1.02m, "Pick up from store for free", "Pickup In-Store" }
                });
